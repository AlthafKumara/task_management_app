...
class LoginPage extends GetView<LoginController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _body(context),
      bottomNavigationBar: _bottomNav(context, controller),
    );
  }
}

PreferredSizeWidget _appbar(BuildContext context, LoginController controller) {
  return AppBar(
...
Widget _bottomNav(BuildContext context, LoginController controller) {
  return Padding(
